...
public class HomeYoutubePages {
 WebDriver driver;
@FindBy(xpath="//a[text()='Home']")
WebElement home;

@FindBy(xpath="//h4[text()='YouTube Channel Advertisement Service']")
WebElement youtube;

@FindBy(xpath="//a[text()='Start Advertising Now']")
WebElement Ads;

@FindBy(xpath="//a[text()='Enable services']")
WebElement enable;
...
public HomeYoutubePages(WebDriver driver) {
    this.driver = driver;
